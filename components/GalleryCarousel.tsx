...
const images = [
  {
    ...
    alt: "Lagree reformer class — woman in terracotta, group session",
    label: "LAGREE",
  },
  {
    src: "/pilates1.png",
    alt: "Reformer detail — hands on the machine, precision movement",
    label: "REFORMER",
  },
  {
    src: "https://images.pexels.com/photos/8436684/pexels-photo-8436684.jpeg",
    alt: "Yoga class — calm and focused movement",
    label: "YOGA",
  },
  {
